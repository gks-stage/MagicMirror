...
window.Modernizr = function(a, b, c) {
    ...
    function C(a, b, d) {
      for (var e in a) {
        var f = b[a[e]];
        if (f !== c) return d === !1 ? a[e] : z(f, "function") ? f.bind(d || b) :
          f;
      }
      return !1;
    }
    ...
    function D(a, b, c) {
      ...
      return z(b, "string") || z(b, "undefined") ? B(e, b) : (e = (a + " " + o.join(
        d + " ") + d).split(" "), C(e, b, c));
    }
    var d = "2.8.3",
      e = {},
  ...
  function(a, b, c) {
    ...
    function j(a, b, c, d, f) {
      return q = 0, b = b || "j", e(a) ? i("c" == b ? v : u, a, b, this.i++, c,
        d, f) : (p.splice(this.i++, 0, a), 1 == p.length && h()), this;
    }
    ...
    B = function(a) {
        function b(a) {
          var a = a.split("!"),
            ...
            e, f, g;
          for (f = 0; f < d; f++) g = a[f].split("="), (e = z[g.shift()]) && (c =
            e(c, g));
        ...
        function g(a, e, f, g, h) {
          ...
          i.url.split(".").pop().split("?").shift(), i.bypass || (e && (e = d(e) ?
            ...
            i.instead(a, e, f, g, h) : (y[i.url] ? i.noexec = !0 : y[i.url] =
              1, f.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(
                  ".").pop().split("?").shift() ? "c" : c, i.noexec, i.attrs,
                i.timeout), (d(e) || d(j)) && f.load(function() {
                k(), e && e(i.origUrl, h, g), j && j(i.origUrl, h, g), y[i.url] =
                  2;
              })));
        }
            ...
            if (a) {
              if (e(a)) c || (j = function() {
                ...
                for (n in m = function() {
                    ...
                    return b;
                  }(), a) a.hasOwnProperty(n) && (!c && !--m && (d(j) ? j =
                  function() {
                    var a = [].slice.call(arguments);
                    k.apply(this, a), l();
                  } : j[n] = function(a) {
        ...
        if (e(a)) g(a, 0, l, 0);
          ...
          for (i = 0; i < a.length; i++) j = a[i], e(j) ? g(j, 0, l, 0) : w(j) ?
        ...
        x.push(a);
      }, B.errorTimeout = 1e4, null == b.readyState && b.addEventListener && (b
        .readyState = "loading", b.addEventListener("DOMContentLoaded", A =
          function() {
